...
int exec() {
  ...
  int cont = 1;
  int addr, val;
  static const void* jmpto[16] = {&&L0,&&L1,&&L2,&&L3,&&L4, &&DEFAULT,&&L6,&&L7,&&L8,&&L9,&&L10,&&L11,&&L12,&&L13,&&L14,&&L15};
  static const void* jmpto2[8] = {&&H0,&&H1,&&H2,&&H3,&&H4,&&H5,&&H6,&&H7};
